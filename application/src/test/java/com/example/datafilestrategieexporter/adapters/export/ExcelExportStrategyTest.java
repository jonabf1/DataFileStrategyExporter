...
public class ExcelExportStrategyTest {
    ...
    public void setUp() {
        ...
        excelExportStrategy = new ExcelExportStrategy(exportDataUseCase);
    }

    @Test
    public void testExport_ShouldExportExcelWithCorrectData() throws IOException {
        ...
        excelExportStrategy.export(null);
